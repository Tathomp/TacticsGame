...
public class GenerateDemoCampaign
{
    ...
    void GenerateAllDefaults()
    {
        ...
        campaign = new Campaign("Demo", "default");
        ...
        contentContainer = new ContentLibrary("demo_content");
    ...
    void Items()
    {
        ...
        */
        ...
        healthpot.descript = "This stuff is magic";
    ...
    void WorldMaps()
    {
        ...
        WorldMapTile tile = new WorldMapTile("field", 0, 9, "grass");
